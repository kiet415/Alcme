 ...
 * @module com.spoonacular.client/com.spoonacular.client.model/InlineObject16
 * @version 1.0
 */
class InlineObject16 {
    /**
     * Constructs a new <code>InlineObject16</code>.
     * @alias module:com.spoonacular.client/com.spoonacular.client.model/InlineObject16
     * @param text {String} The text in which food items, such as dish names and ingredients, should be detected in.
     */
    constructor(text) { 
        
        InlineObject16.initialize(this, text);
    }
     ...
     * @param {module:com.spoonacular.client/com.spoonacular.client.model/InlineObject16} obj Optional instance to populate.
     * @return {module:com.spoonacular.client/com.spoonacular.client.model/InlineObject16} The populated <code>InlineObject16</code> instance.
     */
